...
rect::rect(){
	...
	COORD left_bottom = { rc.right / 2 - 32, rc.bottom / 2 + 15 },		//числа 15 и 32 произвольные
		  right_top = { rc.right / 2 + 32, rc.bottom / 2 - 15 };																	//(÷èñëà 32 è 15 îïðåäåëåíû ìåòîäîì ïîäáîðàè ìîãóò áûòü ïðîèçâîëüíûìè)
...
int main(){
	...
	rect->draw_rect();			//отрисовка первого прямоугольника с начальными параметрами
